...
function ClientGridPage() {
    ...
    return (
        <div className="flex flex-col items-center flex-1 p-6 pb-2 gap-2">
            <h1 className="text-4xl w-full text-left pl-4">Clientes</h1>
            ...
            <Table className="flex-1">
                ...
                <TableBody>
                    <TableRow>
                        <TableCell onClick={onEditClientClick}><PencilIcon className="cursor-pointer" size="20" color="blue"/></TableCell>
